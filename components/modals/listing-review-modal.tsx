...
import { Listing, LISTING_REJECTION_REASONS } from '@/types/api';
import {
  Select,
  SelectContent,
  SelectItem,
...
export function ListingReviewModal({
  ...
  const handleReasonTypeChange = (value: string) => {
    ...
    const selectedOption = LISTING_REJECTION_REASONS.find(r => r.value === value);
    if (selectedOption) {
      if (value === 'other') {
        onReasonChange(customReason);
      } else {
        onReasonChange(selectedOption.label);
      }
    }
  };
        ...
        <div className="flex-1 overflow-hidden">
          <ScrollArea className="h-[400px]">
            ...
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge variant={typeColors[selectedListing.type]} className="mt-1">
                ...
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Owner/Agent</p>
                  <p className="text-base font-medium text-gray-900 dark:text-white">
                    {selectedListing.user?.full_name || 'N/A'}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Current Status</p>
                  <Badge variant={statusColors[selectedListing.status]} className="mt-1">
            ...
            <div className="p-6 space-y-6">
              ...
              {isRejection && (
                <>
                  <div>
                    ...
                    <Select value={selectedReasonType} onValueChange={handleReasonTypeChange}>
              ...
              {isApproval && (
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Add any additional notes about this review (optional)..."
                    rows={4}
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white resize-none"
                  />
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className={`font-medium ${
                        ...
                        {isApproval ? 'Approve Listing' : 'Reject Listing'}
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{selectedListing.user?.full_name}</span>
                    </div>
                    {reviewData.reason && (
              ...
              {isRejection && !reviewData.reason && (
                <p className="text-sm text-red-500">
                  Please select a rejection reason before submitting
                </p>
              )}
            </div>
          </ScrollArea>
